    ...
    <div class="row  hd col-lg-12 col-md-12 col-sm-12 col-xl-12">
      <div class="nav-scroller mb-3 mt-3">
        ...
        <nav class="nav float-end" style="">
          <a href="repro.php"> <button class="m-3 btnnn"><img src="../img/left-arrows.png" width="20px" alt="">
          Back</button> </a>
          <a href="adlogin.php?xyz"><button class="m-3 btnnn"><img src="../img/turn-off.png" width="20px"
                alt="">Logout</button></a>
