...
<body
    style="background-image: url('../img/ring.jpg'); min-height: 900px; background-size: cover; background-repeat: no-repeat; background-position: center;"
    class="w-100">
    <!-- Top Navbar -->
        ...
        <div class="apple">
            <div class="col-md-10">
                ...
                while ($row = $res->fetch()) {
                    ...
                    echo '<a class="myDIV"  href="femaleview.php?idxyz=' . $row['id'] . '"><img class="card-img-top my-3 mx-3" src="img/' . $row['picture'] . '" alt="Card image cap" width="120px" height="170px" style="border-radius: 50%;"></a>';
