...
<body style="background-image: url('../img/bckd3.jpg'); min-height: 700px; background-size: 100% 100%; background-repeat: no-repeat; background-position: center;" class="w-100">
...
?>
    <style>
        ...
        body {
            background-image: url('../img/bckd3.jpg');
...
<header >
          <div class="container-fluid mt-3">
              <small class="ms-5"><b>From tekmatrimony</b><br>
        ...
        <div class="container-fluid" >
            <!-- <div class="row bg-primary-subtle " >             -->
                 <!-- <div class="col-lg-6 ms-5 mt-4">            
                     <img src="img/wd2.jpg" class="rounded float-start mt-3 p-2"  height="10%" width="10%" >
                     <img src="img/wd3.jpg" class="rounded float-start mt-3 p-2" height="150px" width="200px"  ><br>
                     <img src="img/wd4.jpg" class="rounded float-start mt-3 p-2" height="150px" width="200px" >
                     <img src="img/wd5.jpg" class="rounded float-start mt-3 p-2" height="150px" width="200px" >
                 </div> -->
                 <div class="container mt-5">
    <div class="row ">
        <div class="col-lg-4">
            <div class="container mb-3 card-border" style="border-radius: 20px; background-color:rgb(176,4,0,0.2)">
                ...
                <div class="d-grid gap-3 col-xl-6 mx-auto">
                    <!-- <a href="passwordpage/password/admin pannel/pages/forms/welcome.php"> -->
                        <button class="btn  btn-block" onclick="abc()" style="background-color:rgb(82,113,255); color:white;">Login</button>
                    <!-- </a> -->
            ...
            <div class="card-border p-2" style="border-radius: 20px; background-color:rgb(176,4,0,0.2);">
                <p class="text-center">Not a Member? <b class="text-danger">REGISTER FREE</b></p>
            </div>
        </div>
    </div>
</div>
         <!-- </div> -->
<div class="container" style="font-size:18px; font-weight:700;">
    <div class="row  ms-3 mt-5 pt-2">
                 <div class="col-lg-4  " >          
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.trim() === "success") {
                            window.location.href = "../repro.php";
                        } else {
                            document.getElementById("errrmsg").innerHTML = "Wrong Password";
                        }
                    }
